...
if platform.system()=='Darwin':
    PATH = '/Users/dhanley/Documents/rsna-screening'
else:
    PATH = './'
os.chdir(f'{PATH}')
...
cfg.data_folder = cfg.data_dir + "train_cropped_pngs_8bit_v05/" # "train_cropped_pngs_8bit_v01/"
...
#model
cfg.model = "mdl_dh_1_aux9"
#cfg.backbone = 'seresnext50_32x4d'
# cfg.backbone = 'tf_efficientnetv2_s.in1k'
cfg.backbone = 'tf_efficientnet_b5.ns_jft_in1k'
'''
...
# Postprocess
cfg.post_process_pipeline = "pp_ch_1"
# augs & tta
